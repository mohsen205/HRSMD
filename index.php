        ...
        <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist" style="width: 40%;">
            ...
            <li class="nav-item">
                <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab"
                    aria-controls="profile" aria-selected="false">Médecin</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="profile-tab" data-toggle="tab" href="#admin" role="tab" aria-controls="admin"
                    aria-selected="false">Réceptionniste</a>
            </li>
        </ul>
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                <h3 class="register-heading">S'inscrire en tant que patient.</h3>
                <form method="post" action="func2.php">
                    <div class="row register-form">
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Prénom *" name="fname"
            ...
            <div class="tab-pane fade show" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                <h3 class="register-heading">Se connecter en tant que médecin.</h3>
                <form method="post" action="func1.php">
                    <div class="row register-form">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="submit" class="btnRegister" name="docsub1" value="Se connecter" />
                        </div>
                    </div>
                </form>
            ...
            <div class="tab-pane fade show" id="admin" role="tabpanel" aria-labelledby="profile-tab">
                <h3 class="register-heading">Connexion en tant qu'administrateur</h3>
                <form method="post" action="func3.php">
                    <div class="row register-form">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="submit" class="btnRegister" name="adsub" value="Se connecter" />
                        </div>
                    </div>
                </form>
            </div>
